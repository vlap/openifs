...
USE STOCHASTIC_ROUNDING_MOD, ONLY : STOCH_ROUND_INIT
...
INTEGER(KIND=JPIM) :: JGFL, JEMIS, JEMISAUX
...
LOGICAL, POINTER :: LCHEM_DIA, LCHEM_DDFLX, LCOMPO_DDFLX_DIR, LCHEM_TROPO, &
 & LCHEM_TL, LCHEM_LIGHT, LCHEM_DIAC, LCHEM_STMA, LCHEM_BASCOE_JON, LCHEM_EXTENDJNO2, &
 & LCHEM_BASCOE_HETCHEM, LMOZART_RSF_DUMMY, &
 & LCHEM_ANAO3, LCHEM_ANACH4, LCHEM_JOUT, LCHEM_0NOX, LCHEM_HTAP, LCHEM_O3RAD, LCHEM_WDFR, &
 & LCHEM_WEAK_CH4_RELAXATION, &
 & LCHEM_CONVSCAV, LCHEM_CSHAPE, LCHEM_AEROI, LCHEM_LCOMESO, LCHEM_LCOCSTCLIM, LCHEM_LCOLIMIT, &
 & LCOMPO_DCDD, & 
 & LAERNITRATE, LAEREQSAM4CLIM, LAERSOA, LAERSOA_COUPLED, LCHEM_REVCHEM, LAERRESUSPENSION, LAERNUCL, &
 & LCHEM_ARPCLIM
...
TYPE(TYPE_GFL_NAML) :: &
 ...
 & YEZDIAG_NL(JPEZDIAG), YLIMA_NL(JPLIMA), &
 & YEXT_NL(JPGFL-JPNAMED_GFL-JPGHG-JPFORC-JPEZDIAG-JPAERO-JPERA40-JPNOGW-JPEDRP-JPSLDIA-&
 & JPCH4S-JPAEROUT-JPAEROCLIM-NPAERAOT-NPAERLISI-JPUVP-JPCHEM-JPPHYS-JPLIMA)
#else
...
LOGICAL, POINTER :: LAERCHEM, LTRCMFIX, LTRCMFIX_PS, LTRCMFBC, LTRCMFPR, LTRCMFMG, LEXTRADF, &
 ...
 & LTRCMFP, LTRCMFQM, LTRCMFA_DIF, LTRCMFA_VER, LTRCMFA_LAP, LQM3DCONS, LSTOCH_ROUNDING, LSTOCHRND, LSPPTGFL
...
LSTOCHRND      => YGFL%LSTOCH_ROUNDING
...
IF (KIND(1.0_JPRB) == KIND(1.0_JPRD)) THEN
  LSTOCH_ROUNDING=.FALSE.
ELSE
  LSTOCH_ROUNDING=.TRUE.
ENDIF
NOPTMFBC=3
NOPTMFPR=1
NOPTNEGFIX=1
...
WRITE(NULOUT,'(A,L2)') '  LSTOCH_ROUNDING=',LSTOCH_ROUNDING

CALL STOCH_ROUND_INIT(NULOUT, KMYPROC=MYPROC, LDSTOCH_ROUNDING=LSTOCH_ROUNDING)
...
IF(NCHEM > 0 ) THEN
  ...
  WRITE(NULOUT,'(A,L2,A,f10.3,A,L2,A,L2,A,L2,A,L2,A,L2,A,L2)')&
...
!   & '  LCHEM_DIA=',LCHEM_DIA, &
  ...
  WRITE(NULOUT,'(A,I2,A,I2,A,I2,A,L2,A,L2,A,L2,A,L2,A,I2,A,L2,A,I6,A,L2,A,L2,A,L2,A,L2,A,L2,A,L2)')&
